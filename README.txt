...
- [Cocos Creator](https://www.cocos.com/en/) (version 3.x recommended)
...
## License
This project is licensed under the [MIT License](LICENSE). Feel free to modify and distribute the game as per the license terms.
